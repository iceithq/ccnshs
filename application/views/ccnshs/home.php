...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="public/themes/ccnshs/img/hero/01.png?v1">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="public/themes/ccnshs/img/hero/02.png?v1">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="public/themes/ccnshs/img/hero/03.png?v1">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="public/themes/ccnshs/img/hero/04.png?v1">
    </div>
  </div>
