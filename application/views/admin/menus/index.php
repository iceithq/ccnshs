<h3>Menus</h3>
<p>
  <?php echo anchor('menus/add', 'Add menu', 'class="btn btn-success"'); ?>
  <?php echo anchor('sub_menus/add', 'Add sub-menu', 'class="btn btn-success"'); ?>
</p>
  ...
  <?php if (menu_has_sub_menus($menu)): ?>
    <?php foreach ($menu->sub_menus as $sub_menu): ?>
      <tr>
        ...
        <td>
          <?php echo anchor('sub_menus/edit/' . $sub_menu->id . '/' . $sub_menu->menu_id, 'Edit'); ?>
...
<script>
  ...
  function deleteMenu(name, id) {
    ...
    if (c === true) {
      window.location = url + 'menus/delete/' + id;
    } else {
      return false;
    }
  }
